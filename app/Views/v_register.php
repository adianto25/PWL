...
<section class="login-section">
    ...
    <div class="login-card">
        <div class="login-logo">
            ...
            <h3 class="fs-4">Daftar PrajaMukti</h3>
            <p class="text-muted small">Buat akun untuk memulai perjalanan Anda</p>
        </div>
        ...
        <?= form_open('register', 'class="needs-validation"') ?>
            ...
            <div class="float-container">
                <?= form_password($confirm_password_attr) ?>
                <label class="float-label">Konfirmasi Password</label>
            </div>

            <button type="submit" class="btn w-100 login-btn mt-2">Daftar Sekarang</button>
        <?= form_close() ?>

        <div class="text-center mt-4">
            <p class="small mb-0" style="color: #6c757d;">Sudah punya akun? 
                <a href="<?= base_url('login') ?>" style="color: #165F39; font-weight: 700; text-decoration: none;">Masuk di sini</a>
            </p>
        </div>
    </div>
</section>
