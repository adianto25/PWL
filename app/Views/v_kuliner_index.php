...
<style>
    ...
    .searchbar {
      ...
      border-radius: 24px;
      margin: 0;
      width: 100%; /* Changed from max-width: 224px to fill column */
    }
                ...
                <div class="searchbar">
                  <div class="searchbar-wrapper">
                    ...
                    <div class="searchbar-center">
                      ...
                      <input type="text" class="searchbar-input" maxlength="2048" name="keyword" value="<?= esc($_GET['keyword'] ?? '') ?>" autocapitalize="off" autocomplete="off" title="Search" placeholder="Cari produk UMKM..." />
                    </div>
                ...
                <a href="<?= base_url('kuliner/detail/'.$t['id']) ?>">
                    <?php 
                        if (!empty($t['foto_utama'])) {
                            $f_path = $t['foto_utama'];
                            if (strpos($f_path, 'NiceAdmin') !== false || strpos($f_path, 'uploads/') === 0) {
                                $imgSrc = base_url($f_path);
                            } else {
                                $imgSrc = base_url('uploads/'.$f_path);
                            }
                        } else {
