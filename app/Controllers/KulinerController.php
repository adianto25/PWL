...
class KulinerController extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->tempatModel->where('tempat_kuliner.status', 'approved');
        $this->tempatModel->whereIn('kategori.nama_kategori', ['Makanan Berat', 'Jajanan Tradisional', 'Minuman Tradisional', 'Oleh-Oleh']);
